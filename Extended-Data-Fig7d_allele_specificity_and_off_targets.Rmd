...
```{r}
#BRCA2
BRCA2 <- read.csv2("Extended-Data-Fig7d/Extended-Data-Fig7d_BRCA2.txt", sep = ",")
...
write.xlsx(df_BRCA2_on_target, file = "Extended-Data-Fig7d/R_output/BRCA2_on_target_editing.xlsx")
write.xlsx(df_BRCA2_LOH, file = "Extended-Data-Fig7d/R_output/BRCA2_LOH_on_target_editing.xlsx")
write.xlsx(df_BRCA2_WT1, file = "Extended-Data-Fig7d/R_output/BRCA2_WT1_on_target_editing.xlsx")
write.xlsx(df_BRCA2_WT2, file = "Extended-Data-Fig7d/R_output/BRCA2_WT2_on_target_editing.xlsx")
write.xlsx(df_BRCA2_indels, file = "Extended-Data-Fig7d/R_output/BRCA2_indel_on_target_editing.xlsx")
```
...
#PARP1
PARP1 <- read.csv2("Extended-Data-Fig7d/Extended-Data-Fig7d_PARP1.txt", sep = ",")
...
#write output Excels
write.xlsx(df_PARP1_on_target, "Extended-Data-Fig7d/R_output/PARP1_on_target_editing.xlsx")
write.xlsx(df_PARP1_LOH, file = "Extended-Data-Fig7d/R_output/PARP1_LOH_on_target_editing.xlsx")
write.xlsx(df_PARP1_WT1, file = "Extended-Data-Fig7d/R_output/PARP1_WT1_on_target_editing.xlsx")
write.xlsx(df_PARP1_WT2, file = "Extended-Data-Fig7d/R_output/PARP1_WT2_on_target_editing.xlsx")
write.xlsx(df_PARP1_indels, file = "Extended-Data-Fig7d/R_output/PARP1_indel_on_target_editing.xlsx")
...
write.xlsx(df_PARP1_on_target_mixed, file = "Extended-Data-Fig7d/R_output/PARP1_mixed_on_target_editing.xlsx")
```



__Checking for allele specific editing at specific loci in the following two amplicons:  AMPL1036550 and AMPL1036551__


Test off target on AMPL1036550
```{r}
#read in the BRCA2 output from the variant calling
AMPL1036550 <- read.csv2("Extended-Data-Fig7d/off_target_amplicons/Extended-Data-Fig7d_AMPL1036550.txt", sep = ",")

#rename the alleles with the amplicon target
AMPL1036550 <- rename(AMPL1036550, "allele1_AMPL1036550" = allele1)
AMPL1036550 <- rename(AMPL1036550, "allele2_AMPL1036550" = allele2)

#remove all the cells that didn't pass QC (thus, variant called as [None])
AMPL1036550 <- AMPL1036550 %>% filter(allele1_AMPL1036550 != "[None]") %>% filter(allele2_AMPL1036550 != "[None]") %>% select(-X)

#count all unique conbinations of varients on the PARP1 loci and XAF1 loci
AMPL1036550 <- AMPL1036550 %>% group_by(allele1_AMPL1036550, allele2_AMPL1036550) %>% count(allele1_AMPL1036550, allele2_AMPL1036550, sort = T)

#write out summary table for AMPL1036549 genotypes
write.xlsx(AMPL1036550, file = "Extended-Data-Fig7d/R_output/AMPL1036550_genotype_combinations.xlsx")


#cells with at least one AMPL1036550 LOH
BRCA2_LOH_combinations <- AMPL1036550 %>% filter(allele1_AMPL1036550 == "['chr13:32332931:A/T']" | allele2_AMPL1036550 == "['chr13:32332931:A/T']")

#write out the table
write.xlsx(BRCA2_LOH_combinations, file = "Extended-Data-Fig7d/R_output/AMPL1036550_LOH_combinations.xlsx")

#cells with at least one AMPL1036550 WT1
BRCA2_WT1_combinations <- AMPL1036550 %>% filter(allele1_AMPL1036550 == "['chr13:32332930:A/T']" | allele2_AMPL1036550 == "['chr13:32332930:A/T']")

#write out the table
write.xlsx(BRCA2_WT1_combinations, file = "Extended-Data-Fig7d/R_output/AMPL1036550_WT1_combinations.xlsx")

#cells with at least one AMPL1036550 WT2
BRCA2_WT2_combinations <- AMPL1036550 %>% filter(allele1_AMPL1036550 == "['chr13:32332933:G/A']" | allele2_AMPL1036550 == "['chr13:32332933:G/A']")

#write out the table
write.xlsx(BRCA2_WT2_combinations, file = "Extended-Data-Fig7d/R_output/AMPL1036550_WT2_combinations.xlsx")
```

Test off target on AMPL1036551
```{r}
#read in the BRCA2 output from the variant calling
AMPL1036551 <- read.csv2("Extended-Data-Fig7d/off_target_amplicons/Extended-Data-Fig7d_AMPL1036551.txt", sep = ",")

#rename the alleles with the amplicon target
AMPL1036551 <- rename(AMPL1036551, "allele1_AMPL1036551" = allele1)
AMPL1036551 <- rename(AMPL1036551, "allele2_AMPL1036551" = allele2)

test <- AMPL1036551

#remove all the cells that didn't pass QC (thus, variant called as [None])
AMPL1036551 <- AMPL1036551 %>% filter(allele1_AMPL1036551 != "[None]") %>% filter(allele2_AMPL1036551 != "[None]") %>% select(-X)

#count all unique combinations of variants on the AMPL1036551 loci
AMPL1036551 <- AMPL1036551 %>% group_by(allele1_AMPL1036551, allele2_AMPL1036551) %>% count(allele1_AMPL1036551, allele2_AMPL1036551, sort = T)

#write out summary table for AMPL1036549 genotypes
write.xlsx(AMPL1036551, file = "Extended-Data-Fig7d/R_output/AMPL1036551_genotype_combinations.xlsx")


#cells with at least one AMPL1036551 LOH
BRCA2_LOH_combinations <- AMPL1036551 %>% filter(allele1_AMPL1036551 == "['chr13:32379908:C/T', 'chr13:32379909:T/A']" | allele2_AMPL1036551 == "['chr13:32379908:C/T', 'chr13:32379909:T/A']")

#write out the table
write.xlsx(BRCA2_LOH_combinations, file = "Extended-Data-Fig7d/R_output/AMPL1036551_LOH_combinations.xlsx")

#cells with at least one AMPL1036551 WT1
BRCA2_WT1_combinations <- AMPL1036551 %>% filter(allele1_AMPL1036551 == "['chr13:32379907:A/G']" | allele2_AMPL1036551 == "['chr13:32379907:A/G']")

#write out the table
write.xlsx(BRCA2_WT1_combinations, file = "Extended-Data-Fig7d/R_output/AMPL1036551_WT1_combinations.xlsx")

#cells with at least one AMPL1036551 WT2
BRCA2_WT2_combinations <- AMPL1036551 %>% filter(allele1_AMPL1036551 == "['chr13:32379910:A/T']" | allele2_AMPL1036551 == "['chr13:32379910:A/T']")

#write out the table
write.xlsx(BRCA2_WT2_combinations, file = "Extended-Data-Fig7d/R_output/AMPL1036551_WT2_combinations.xlsx")
```
...
folder_path <- "Extended-Data-Fig7d/off_target_amplicons/"
...
write.xlsx(AMPL1023258, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023258_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023259, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023259_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023260, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023260_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023261, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023261_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023263, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023263_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023264, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023264_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023265, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023265_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023266, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023266_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023267, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023267_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023268, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023268_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023269, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023269_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023270, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023270_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023273, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023273_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023274, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023274_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023275, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023275_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023276, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023276_frameshift_indel_off_targets.xlsx")
```
...
#write an excel of the combinations
write.xlsx(AMPL1023277, file = "Extended-Data-Fig7d/off_target_amplicons/excels_off_target/AMPL1023277_frameshift_indel_off_targets.xlsx")
```
